                  ...
                  <div class="list-product-header">
                    <div>
                      <div class="light-box"><a data-bs-toggle="collapse" href="#collapseProduct" role="button"
                        ...
                        class="btn btn-primary" href="blog.php"><i class="fa-solid fa-plus"></i>Add blog</a>
                    </div>
    ...
    $.ajax({  // Fixed $.ajax()
        ...
        success: function (data) {
            if (data == "0") {
                ...
                window.location.href = "contact.php";  // Redirect after successful delete
            } else {

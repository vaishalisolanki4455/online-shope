                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">deals Create</li>
                                ...
                                <div class="card-body">
                                    <div class="form theme-form basic-form">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <h5 class="f-w-600 mb-2">deals Title </h5>
                                                    <input type="hidden" name="id" id="id"
                                                        value="<?php echo $row['id'] ?? ''; ?>">
                                                    <input class="form-control" type="text"
                                                        value="<?php echo $row['deals'] ?? ''; ?>" name="deals"
                                                        id="deals" placeholder="deals name *">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description"
                                                value="<?php echo $row['description'] ?? ''; ?>" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="text-end mt-3">
                                                ...
                                                if ($id == '') {
                                                    ?>
                                                    <button class="btn btn-primary" type="submit" onclick="insertdata()">
                                                        Add </button>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <button class="btn btn-danger" type="submit" onclick="updatedata()">
                                                        update </button>
                                                    <?php
                                                }
                                                ?>

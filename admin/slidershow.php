                  ...
                  <div class="list-product-header">
                    <div>
                      <div class="light-box"><a data-bs-toggle="collapse" href="#collapseProduct" role="button"
                        ...
                        class="btn btn-primary" href="slider.php"><i class="fa-solid fa-plus"></i>Add slider</a>
                    </div>
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 0) {
            alert("data delete");
            getdata();
            window.location.href = 'slidershow.php';

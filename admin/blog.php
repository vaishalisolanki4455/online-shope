                                ...
                                <div class="card-body">
                                    <div class="form theme-form basic-form">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <h5 class="f-w-600 mb-2">blog Title </h5>
                                                    <input type="hidden" name="id" id="id"
                                                        value="<?php echo $row['id'] ?? ''; ?>">
                                                    <input class="form-control" type="text"
                                                        value="<?php echo $row['blog'] ?? ''; ?>" name="blog" id="blog"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description" value="<?php echo $row['description'] ?? ''; ?>" class="form-control" rows="3" placeholder="description *">

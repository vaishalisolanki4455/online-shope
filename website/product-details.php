...
<head>
  <meta charset="utf-8">
  <title>Grocee - Product Details</title>
...
<body>
    ...
    <div class="modal" id="modal1" data-animation="slideInUp">
        ...
        <div class="quickview__inner">
                <div class="row row-cols-lg-2 row-cols-md-2">
                    <div class="col">
                        <div class="quickview__gallery quickview__swiper--activation swiper mb-20">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="assets/img/product/big-product1.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                        ...
                        <div class="quickview__social quickview__social--style3 d-flex align-items-center justify-content-center">
                            <label class="quickview__social--title">Social Share:</label>
                            <ul class="quickview__social--wrapper mt-0 d-flex">
                                <li class="quickview__social--list">
                                    <a class="quickview__social--icon" target="_blank" href="https://www.facebook.com/">
